...
@Component
public class HolidayBalancesResourceAssembler implements ResourceAssembler<HolidayBalances, ResourceSupport>{

    @Override
    public ResourceSupport toResource(HolidayBalances entity) {
